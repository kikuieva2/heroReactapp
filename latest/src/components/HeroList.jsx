    ...
    render() {
        const heroes = [
            ...
            },
            {
                ...
                superpowers: "непревзойденная сила, скорость, выносливость",
                url: "https://n1s1.hsmedia.ru/ec/73/6b/ec736b6c1168cf4ea616d9f1e9d27a49/600x500_0xac120002_8362075071540489258.jpg",
                info: "Супермен — один из самых известных супергероев, он может летать и обладает огромной силой...",
            },
            {
              ...
              friends: "Мстители",
              superpowers: "высокий уровень интеллекта, широкие познания науки и техники, связь со всемирной паутиной",
        ...
        return (
            <div>
                {heroes.map((hero, index) => (
                    <HeroDescription key={index} hero={hero} />
                ))}
            </div>
        );
    }
